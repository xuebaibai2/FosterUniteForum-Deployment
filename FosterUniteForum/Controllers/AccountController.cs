            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    using (var context = new ForumDbContext())
                    {
                        ...
                        forumUser.ProviderId = user.Id;
                        forumUser.FirstName = model.FirstName;
                        forumUser.LastName = model.LastName;
                        forumUser.EmailAddress = model.Email;
                        forumUser.Gender = model.Gender;
                        forumUser.City = model.City;
                        forumUser.State = model.State;
                        forumUser.Birthday = model.Birthday;
                        forumUser.CompanyName = model.CompanyName;
                        forumUser.CompanyAddress = model.CompanyAddress;
                        forumUser.FirstVisit = DateTime.Now.ToString();
                        forumUser.LastVisit = DateTime.Now.ToString();
